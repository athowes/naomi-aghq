...
Using data from Malawi, our method provides more accurate inferences than `TMB`, and is substantially faster to run to Hamiltonian Monte Carlo with the No-U-Turn sampler.
