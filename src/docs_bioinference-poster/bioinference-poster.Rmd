...
* Kolmogorov-Smirnov (KS) test based on the maximum difference between marginal ECDFs
  * Reduces average KS distance from 0.08 to 0.075
* Also considering joints via Pareto-smoothed importance sampling and maximum mean discrepancy
* Naomi can be used to assess probabilites targets have been met e.g. 90% of those who know their HIV status are on ART ("second 90")
  * Reduces RMSE for estimating second 90 exceedance probabilities by 10%

```{r}
# knitr::include_graphics("fig4.png")
# Figure of Second 90 here
```
