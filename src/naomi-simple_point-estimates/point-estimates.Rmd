...
(mean_sd_plot_latent <- df_plot_latent %>%
...
ggsave("mean-sd-latent.png", mean_sd_plot_latent, h = 6, w = 6.25)
```
...
(mean_sd_plot_output <- df_plot_output %>%
  ggplot() +
...
ggsave("mean-sd-output.png", mean_sd_plot_output, h = 6, w = 6.25)
```
...
ggsave("mean-sd-alt-output.png", mean_sd_plot_output_alt, h = 6, w = 6.25)
```
