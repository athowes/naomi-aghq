...
ks_plot(ks_df = ks_lambda_t1_out %>% filter(!(age_group %in% c("Y005_009", "Y010_014", "Y080_999"))), par = "lambda_t1_out", alpha = 0.2)
```

What is going on with those very high values of KS?
