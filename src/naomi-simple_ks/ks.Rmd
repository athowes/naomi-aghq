...
Filter out the age group 5-9, 10-14 and 80+ here becausethere are new new infections in those age groups, and the posterior samples from each method are exactly the same: in particular draws of identically zero.
...
```{r}
ks_table(ks_summary, type = "Latent field")
```
