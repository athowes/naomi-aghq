...
As well as the standard `TMB` inference approach, this template allows the model to be fit using Stan via `tmbstan` and using adaptive Gaussian Hermite quadrature via `aghq`.
