...
# Histograms and empirical cumulative distribution plots {.tabset .tabset-fade}

We create histograms and empirical cumulative distribution function (ECDF) plots of the samples from each method.
