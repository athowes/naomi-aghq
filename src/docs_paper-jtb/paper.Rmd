...
Section \@ref(sec:naomi) show that the Naomi model involves many-to-one mappings of latent field components to the structured additive predictor for each response.
