...
The proportion recently infected $\kappa_i$ is linked to HIV incidence via a reformulation of the Kassanjee \textit{et al.} biomarker-based incidence estimator (INSERT REFERENCE: https://pubmed.ncbi.nlm.nih.gov/22627902/):
