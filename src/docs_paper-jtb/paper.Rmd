...
The principal component (PC) loadings (Figure \{fig:pc-loadings}) provide interpretable information about which directions had the greatest variation.
...
Posterior inferences from GEB, GPCA-AGHQ and NUTS were compared using point estimates (Section \@ref(point-estimates)), distributional quantities (Section \@ref(distributional-quantities)), and exceedance probabilities (Section \@ref(exceedance))
