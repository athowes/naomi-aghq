...
The Naomi small-area estimation model [@eaton2021naomi] addresses these challenges by synthesising data from multiple sources to estimate HIV indicators at a district-level, by age and sex.
...
An overview of the simplified model is given below, and Appendix \ref{sec:math} provides a full specification.
