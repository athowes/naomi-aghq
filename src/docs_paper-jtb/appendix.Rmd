...
```{r}
point_summary <- readr::read_csv("depends/point-estimates.csv")

point_summary <- point_summary |>
  mutate(type = forcats::fct_recode(type, "Output" = "output", "Latent" = "latent"))
...
ks_summary |>
  ...
  filter(type == "Latent") |>
  select(-type) |>
  select(Parameter = parname, TMB, `PCA-AGHQ` = aghq) |>
