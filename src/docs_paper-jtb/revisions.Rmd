...
> On the proportion recently infected and ANC offsets

Some HIV surveys provide bio-marker data on whether or not the infection was recent.
The equation in the manuscript links the probability of recent infection to HIV prevalence, HIV incidence, and properties of the recent infection assay.
...
To do so, we have grouped the parameters by the model component (e.g. HIV prevalence), and used colour to represent the type of parameter (e.g. intercept).
