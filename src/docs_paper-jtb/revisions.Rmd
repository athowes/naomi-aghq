...
> Section 3 show that the Naomi model involves many-to-one mappings of latent field components to thestructured additive predictor for each response. Because of this, the Naomi model cannot be written as anLGM of the form described in Section 2.1, but can be written as an ELGM.
...
We agree this is an interesting area for future work, and have added a sentence to Section 6.1.2. discussing the possibility of doing this in `TMB`:
