...
Suppose that $\theta = (\theta_1, \theta_2)$ has a multivariate Gaussian distribution with mean vector $\mu$ and covariance matrix $\Sigma$:
...
Create a mapping $\theta(z)$ from the $z$-coordinates to the space of $\theta$:
...
Expand the scaffold in $z$-space:
