...
```{r, echo=FALSE, message=FALSE, fig.cap="If you reconstruct the Hessian with just those 8 dimensions, it looks pretty similar.", out.width = '90%'}
...
```{r, echo=FALSE, fig.cap="Custom version of Laplace marginals implemented using \\texttt{TMB}. Speed-up possible using Simon Wood's method? For the Epilepsy example from Rue (2009), see \\texttt{athowes/elgm-inf/src/epil}.", out.width = '60%'}
