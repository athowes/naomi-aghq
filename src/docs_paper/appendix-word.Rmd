---
title: "Appendix to \"Fast approximate Bayesian inference for small-area estimation
  of HIV indicators using the Naomi model\""
author:
...
- Jeffrey W. Eaton^[Department of Infectious Disease Epidemiology, Imperial College
  London]
output:
  word_document:
    toc: yes
