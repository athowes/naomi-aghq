...
# Complete Naomi model description
...
Consider two time-points $t \in \{T_1, T_2\}$, specified to the nearest calendar quarter: $T_1$, the time period of the most recent national household survey with HIV testing, and $T_2$, the current time period at which to generate estimates.
...
* $u \sim \text{ICAR}(\sigma)$ refers to the Besag intrinsic conditional auto-regressive model (ICAR) with marginal standard deviation $\sigma > 0$.
