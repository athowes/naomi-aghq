...
$$
where $j$ indexes individuals across all strata $i \in \mathcal{I}$ and $w_j$ are design weights.
...
We calculate the observed number of outcomes as $y^{\hat \theta}_{\mathcal{I}} = m^{\hat \theta}_{\mathcal{I}} \cdot \hat \theta_{\mathcal{I}}$ where
$$
