...
In this work, we consider a modified version of the model, with temporal projection omitted.
In this section, we provide an overview of the model structure, with full details provided in the appendix.
