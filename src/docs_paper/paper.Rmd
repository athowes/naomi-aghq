...
Let $i$ index the coarsest space-age-sex division included in the model.
Let $N_i$ be the population size and consider the following indicators: HIV prevalence $\rho_i$, annual HIV incidence rate $\lambda_i$ and ART coverage $\alpha_i$.
