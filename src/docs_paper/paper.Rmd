...
As a case study, we compare the accuracy of our inference method to `TMB` and `tmbstan` for the simplified Naomi model fit to data from Malawi, in Section \ref{sec:results}.
...
These were:
1. TMB,
2. PCA-AGHQ, building upon the `aghq` package [@stringer2021implementing],
