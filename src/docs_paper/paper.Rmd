...
In our application, this results in a grid which has millions of times fewer nodes the corresponding dense grid.
...
(ref:mean-sd) Barplot displaying frequency of dependencies for all of the R packages in the CRAN repository to date `r Sys.Date()
