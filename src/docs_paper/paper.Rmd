...
As variability can be explained either by high standard deviation and high correlation or low standard deviation and low correlation these parameters are weakly identified.
This is reflected in high correlation in the the NUTS posterior pairs plot (Figure S10, average absolute correlation across all four pairs of `r ar1_mean_cor`).
