...
Importantly, this allows for the presence of more non-linearity in the model than is allowed in LGMs.
...
The Naomi model falls into the ELGM class as follows.
