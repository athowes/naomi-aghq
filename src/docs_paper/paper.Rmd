...
\end{equation*}
Consider approximations to the posterior marginals of each latent random variable $x_i$ and hyperparameter $\theta_j$ given by
\begin{align}
...
Posterior distributions can typically be expected to be relatively well described by this class of functions.
