...
We consider a simplified version defined only at the time of the most recent household survey with HIV testing ($T_1$), omitting nowcasting ($T_2$) and temporal projection ($T_3$), as these time points involve limited additional inference.
...
We infer the following unknown HIV indicators: HIV prevalence $\rho_i \in [0, 1]$, the proportion of individuals who are HIV positive; antiretroviral therapy (ART) coverage $\alpha_i \in [0, 1]$, the proportion of people living with HIV who receive ART treatment; and annual HIV incidence rate $\lambda_i > 0$, the yearly rate of new HIV infections occurring.
...
The Naomi model is not an LGM, and instead falls into the ELGM class.
