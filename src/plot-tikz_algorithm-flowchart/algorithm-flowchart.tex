...
\begin{tikzpicture}[node distance = 2cm, auto]
    ...
    % x
    \node[category] at (0, -3) (a) {$\tilde p_{\text{LA}}(x_i, \btheta, \y)$};
    \node[category] at (0, -6) (b) {$\tilde p_{\text{AQ}}(x_i, \y)$};
    \node[category] at (0, -9) (c) {$\tilde p_{\text{AQ}}(x_i \, | \, \y)$};
    \node[category] at (0, -12) (d) {Image of a nice curve};
    \path[line] (1) -- node[align=center] {Laplace approximation\\Integrate out $\tilde p_{\text{G}}(\x_{-i} \, | \, x_i, \btheta, \y)$}(a);
    \path[line] (a) -- node[align=center] {Integrate out $\theta$\\$\sum_\z \tilde p_{\text{LA}}(x_i, \btheta(\z), \y) \omega(\z)$}(b);
    ...
    % theta
    \node[category] at (8, 0) (2) {$\tilde p_{\text{LA}}(\btheta, \y)$};
    \node[category] at (8, -3) (3) {$\tilde p_{\text{AQ}}(\y)$};
    \node[category] at (8, -6) (4) {$\tilde p_{\text{AQ}}(\btheta \, | \, \y)$};
    \node[category] at (8, -9) (5) {$\tilde p_{\text{AQ}}(\theta_j \, | \, \y)$};
    \node[category] at (8, -12) (6) {Image of a nice curve};
    \path[line] (1) -- node[align=center] {Laplace approximation\\Integrate out $\tilde p_{\text{G}}(\x \, | \, \btheta, \y)$}(2);
