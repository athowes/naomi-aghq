...
* [aghq-grid-scale-up](https://athowes.github.io/elgm-inf/model-checks.html): how can we scale up the number of points in the hyperparameter grid in an intelligent way?
